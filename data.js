...
window.GAME_DATA = (() => {
  ...
  const RECIPES = [
    ...
    { inputs:['h','h','o'], output:'water',
      note:'2H₂ + O₂ → 2H₂O. Violently exothermic — this is the reaction in hydrogen rocket engines. Two hydrogens and an oxygen, bent at 104.5°, and the most important molecule on Earth.' },
    ...
    { inputs:['o','o','o'], output:'ozone',
      note:'3O → O₃. In reality, UV light or lightning splits O₂ and the free atoms stick to other O₂ molecules. A strained molecule — useful high up, harmful at ground level.' },
    ...
    { inputs:['h','h','o','o'], output:'peroxide',
      note:'H₂ + O₂ → H₂O₂ (in practice made industrially via the anthraquinone process). One more oxygen than water, joined by a weak O–O bond that\'s eager to break.' },
    ...
    { inputs:['c','h','h','h','h'], output:'methane',
    ...
    { inputs:['c','c','h','h','h','h'], output:'ethylene',
      note:'2C + 2H₂ → C₂H₄, with a C=C double bond. That double bond is a reactive handle — it\'s how ethylene chains into polyethylene, the world\'s most common plastic.' },
    ...
    // --- Sulfur chemistry ---
    { inputs:['h','h','s'], output:'hydrogen-sulfide',
